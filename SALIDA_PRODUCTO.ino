...
// -------- WIFI --------
#define WIFI_SSID "INFINITUM9B08" //Nombre de la red
#define WIFI_PASSWORD "qMs3Y74dx7" //Contraseña de la red

// -------- FIREBASE --------
#define API_KEY "AIzaSyAtk_GeNUEOzBQnPQvJsUEdQVEGaQRExg8" //API Google Firebase
#define DATABASE_URL "https://traslado-almacen-default-rtdb.firebaseio.com/" //Ruta donde se almacenara los valores
#define DATABASE_SECRET "Vai7xSOJb66Ig0ZKCrjmPB8y6Ro4rvjO360qjGoD" //Token de seguridad para cifrado ssl

// -------- DEFINIR ALMACEN --------
#define ALMACEN "A"   // CAMBIAR A "B" EN EL OTRO ESP
